	...
	return (
		<Section classProp={`${looking.section} borderBottom`}>	
			<Container classProp={`${section.title} ${looking.container}`} spacing={['verticalXXXLrg']}>
				<h4>I&apos;m currently seeking opportunities.</h4>
				<h2 className={looking.json}>in : &#123;</h2>
				<h2 className={looking.jsonSub}><span className={looking.highlight}>UI/UX Designer</span>,</h2>
				<h2 className={looking.jsonSub}><span className={looking.highlight2}>Grapgic Designer</span></h2>
