		...
		<Html lang="en">
            ...
            <Head>
                ...
                <meta name="description"
                      content="Pawanya Kariyawasam - A dedicated Full Stack Developer proficient in App/Web, Cloud, DevOps, AL/ML, and Design. Join my journey."/>

                {/*These are need for PWA*/}
                <meta name="apple-mobile-web-app-capablse" content="yes"/>
