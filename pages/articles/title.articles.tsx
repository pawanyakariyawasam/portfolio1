...
export default function TitleArticles() {
    return (
        <Head>
            ...
            <title>Articles by Pawanya Kariyawasam</title>
            <meta name="description" content="Explore articles authored by Pawanya Kariyawasam, a Full Stack Engineer and Developer." />
