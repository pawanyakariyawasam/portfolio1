...
export default function TitleDocs() {
    return (
        <Head>
            ...
            <meta name="description" content="Explore a collection of documentation for my Open Source projects authored by Pawanya, covering various technology topics." />
            ...
            <title>Documentations | Pawanya Kariyawasam</title>
        </Head>
    );
}
